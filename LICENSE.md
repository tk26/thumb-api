# Thumb API - Terms and conditions

1.Preamble: This Agreement, signed on Jan 8, 2018 (hereinafter: Effective Date) governs the relationship between Thumb, a Business Entity, (hereinafter: Licensee) and Thumb, a private person whose principal place of business is {location} (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Thumb API (hereinafter: The Software) created and owned by Licensor, as detailed herein
