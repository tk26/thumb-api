...
exports.saveRide = async function(ride){
  ...
  query += 'MERGE(user)-[:POSTS]->(r:Ride{rideId:{rideId},travelDate:{travelDate},travelTime:{travelTime},pickupNotes:{pickupNotes},travelDescription:{travelDescription},createdDate:{createdDate}})' + endOfLine;
